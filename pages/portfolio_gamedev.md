...
{% include video.html src="/assets/video/portfolio_games_reel.mp4" %}

I place strong emphasis on skill expression, depth of challenge and intuitive design. I have contributed to games with a nice range of styles in various roles, but I also do a little bit of everything for my solo-work.

***

![Gunpong](/assets/img/gunpong.png)
# GUNPONG
##### TBA | Windows, Mac, Linux

2D platforming arena shooter with recoil-based movement and intricate scoring mechanics. [Download the prototype here.](https://www.icloud.com/iclouddrive/003FeB_bN0gi9WB-W6cW1LZkA#gunpong_prototype)
